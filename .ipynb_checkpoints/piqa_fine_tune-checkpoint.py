...
def create_model_and_tokenizer():
    pruned_dict = torch.load("prune_log/taylor/param_first/group_reduction/sum/pytorch_model.bin", map_location='cpu')
...
OUTPUT_DIR = "tune_log/taylor/param_first/group_reduction/sum/piqa/train/piqa_B4_G16_R8_A16"
