...
# CUDA_VISIBLE_DEVICES=3 bash scripts/0.5/evaluate.sh baffo32/decapoda-research-llama-7B-hf tune_log/taylor/param_first/group_reduction/sum/0.5 prune_log/taylor/param_first/group_reduction/sum/0.5 taylor/param_first/group_reduction/sum/0.5 200 400 600 800 1000 1200 1400
